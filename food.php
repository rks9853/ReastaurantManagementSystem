...
<body>
    ...
    <header class="topbar fixed-top">
        <div class="container flex justify-between items-center">
             <div class="icons">
              ...
              <div>
                 ...
                 <option value="http://localhost/FoodRestaurant/login.php">Customer</option>
                 <option value="http://localhost/FoodRestaurant/admin/admin_login.php">Admin</option>
                </select>
        ...
        <span class="divider">|</span>
           ...
           <a href="warning3.php">my cart (0)</a>
          </div>
          <span class="divider">|</span>
                        ...
                        <div class="container">
                            <h1 class="section-heading text-pure">Category</h1>
                                ...
                                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                    ...
                                    <a href="veg.php"><img src="./images/vegg.jpg" width="450px" height="450px" alt="" ></a> &nbsp; &nbsp;&nbsp; &nbsp;
                                    <a href="non-veg.php"><img src="./images/non-veg.jpg" width="450px" height="450px" alt="" ></a>
                                    <br><br> <br><br> <br><br>
                        ...
                        <div class="container">
                          ...
                          <div class="row product-items" id="product-items">
                              <div class="col-10 col-sm-8 col-lg-4 mx-auto my-3">
                                  <div class="card single-item">
                                      <div class="img-container">
                                         <a href="warning1.php"> <img src="./images/matar.jpeg" alt="" 
                              ...
                              <div class="col-10 col-sm-8 col-lg-4 mx-auto my-3">
                                  <div class="card single-item">
                                      <div class="img-container">
                                          <a href="warning1.php"><img src="./images/chicken lollipop.jpeg" alt="" 
                                          class="card-img-top product-img"></a>
                              ...
                              <div class="col-10 col-sm-8 col-lg-4 mx-auto my-3">
                                  <div class="card single-item">
                                      <div class="img-container">
                                          <a href="warning1.php"><img src="./images/allo kobi bhaja.jpeg" alt="" 
                                          class="card-img-top product-img"></a>
                              ...
                              <div class="col-10 col-sm-8 col-lg-4 mx-auto my-3">
                                  <div class="card single-item">
                                      <div class="img-container">
                                      <a href="warning1.php"><img src="./images/bitter chips.jpeg" alt="" 
                                          class="card-img-top product-img"></a>
                              ...
                              <div class="col-10 col-sm-8 col-lg-4 mx-auto my-3">
                                  <div class="card single-item">
                                      <div class="img-container">
                                      <a href="warning1.php"><img src="./images/chingudi.jpeg" alt="" 
                                          class="card-img-top product-img"></a>
                              ...
                              <div class="col-10 col-sm-8 col-lg-4 mx-auto my-3">
                                  <div class="card single-item">
                                      <div class="img-container">
                                      <a href="warning1.php"><img src="./images/jeera rice.jpeg" alt="" 
                                          class="card-img-top product-img"></a>
                              ...
                              <div class="col-10 col-sm-8 col-lg-4 mx-auto my-3">
                                  <div class="card single-item">
                                      <div class="img-container">
                                      <a href="warning1.php"><img src="./images/morton.jpeg" alt="" 
                                          class="card-img-top product-img"></a>
                              ...
                              <div class="col-10 col-sm-8 col-lg-4 mx-auto my-3">
                                  <div class="card single-item">
                                      <div class="img-container">
                                      <a href="warning1.php"><img src="./images/noodles.jpeg" alt="" 
                                          class="card-img-top product-img"></a>
                              ...
                              <div class="col-10 col-sm-8 col-lg-4 mx-auto my-3">
                                  <div class="card single-item">
                                      <div class="img-container">
                                      <a href="warning1.php"><img src="./images/springroll.jpeg" alt="" 
                                          class="card-img-top product-img"></a>
                              ...
                              <div class="col-10 col-sm-8 col-lg-4 mx-auto my-3">
                                  <div class="card single-item">
                                      <div class="img-container">
                                      <a href="warning1.php"><img src="./images/egg biriyani.jpeg" alt="" 
                                          class="card-img-top product-img"></a>
                              ...
                              <div class="col-10 col-sm-8 col-lg-4 mx-auto my-3">
                                  <div class="card single-item">
                                      <div class="img-container">
                                      <a href="warning1.php"><img src="./images/pannier finger.jpeg" alt="" 
                                          class="card-img-top product-img"></a>
                              ...
                              <div class="col-10 col-sm-8 col-lg-4 mx-auto my-3">
                                  <div class="card single-item">
                                      <div class="img-container">
                                      <a href="warning1.php"><img src="./images/salad-table.jpg" alt="" 
                                          class="card-img-top product-img"></a>

                                      </div>
                                      <div class="card-body">
                                          <div class="card-text d-flex justify-content-between text-capitalize">
                                              <h5 id="item-name">SALAD</h5>
                                              <span><i class="fas fa-dollar-sign"></i>Rs. 50</span>
                                          </div>
                                      </div>
                                  </div>
                              </div>
                       ...
                       <div class="container">
                           ...
                           <div class="card-wrapper flex">
                               <div class="service-card magic-shadow-sm">
                                  ...
                                  <a href="warning2.php"><button class="btn btn-secondary">Order Now</button></a>
                               </div>
                               <div class="service-card magic-shadow-sm">
                                   ...
                                   <a href="warning2.php"><button class="btn btn-primary">Reserve Now</button></a>
                               </div>
                               <div class="service-card magic-shadow-sm">
                                   <img class="icon" src="./icons/usd.svg" alt="">
                                   <h2>Survey Form</h2>
                                   <p>Thank u for agreeing 2 complete this imp. customer survey.</p>
                                   <a href="warning2.php"><button class="btn btn-secondary">Fill Up</button></a>
                               </div>
                           </div>
